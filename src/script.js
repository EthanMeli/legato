(function () {
  ...
  const client_id = 'b4c9f20d1559412fbd674a17e3300f1e';
  const redirect_uri = 'https://127.0.0.1:5173/'; // Your redirect uri
  ...
  const queueForm = document.getElementById('addToQueue');
  queueForm
    .addEventListener("submit", (event) => {
      ...
      fetch(`https://api.spotify.com/v1/me/player/queue?uri=${data['track_uri']}`, {
        method: 'POST',
        headers: {
          Authorization: 'Bearer ' + access_token,
        },
